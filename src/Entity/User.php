...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\CitationInternaute", mappedBy="userAjout")
     */
    private $citations;
    ...
    /**
     * @return Collection|CitationInternaute[]
     */
    ...
    public function addCitation(CitationInternaute $citation): self
    {
    ...
    public function removeCitation(CitationInternaute $citation): self
    {
        if ($this->citations->contains($citation)) {
